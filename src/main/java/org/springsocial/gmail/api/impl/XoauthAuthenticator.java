...
public class XoauthAuthenticator {
	public static final class XoauthProvider extends Provider {
		public XoauthProvider() {
			...
			put("SaslClientFactory.XOAUTH",
					"org.bdigital.springsocial.gmail.api.impl.XoauthSaslClientFactory");
		}
	}
	 ...
	 * Only allows connection but it is not functional to make SMTP and IMAP
	 * operations
	 */
	public static void main(String args[]) throws Exception {
		...
		connectToSmtp("smtp.googlemail.com", 587,
				email, oauthToken, oauthTokenSecret, getAnonymousConsumer(),
				true);
		System.out.println("Successfully authenticated to SMTP.");
		connectToImap("imap.googlemail.com", 993,
				email, oauthToken, oauthTokenSecret, getAnonymousConsumer(),
				true);
